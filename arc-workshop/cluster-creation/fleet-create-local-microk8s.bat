# make sure you create an external network in Hyper-V called "External"
# also make sure all your environment variables are set from ..\account-management\environment-variables-set.ps1
